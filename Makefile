...
EXTRA_FLAGS += -DPOPCNT_CAPABILITY -std=c++17
INC += -I. -I third_party 
...
hisat-3n-table-d: hisat_3n_table.cpp $(THREE_N_HEADERS)
	$(CXX) $(DEBUG_FLAGS) $(DEBUG_DEFS) $(EXTRA_FLAGS) $(NOASSERT_FLAGS) $(DEFS) -pthread -g -o $@ $<
# HT2LIB targets
#
